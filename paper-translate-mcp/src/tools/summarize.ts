...
import { generateSummary, SamplingFunction } from '../api/translator.js';
...
export async function summarizePaper(
  ...
  try {
    ...
    const summary = await generateSummary({
      ...
      introduction: introSection ? introSection.content.slice(0, 3000) : '',
      conclusion: conclusionSection ? conclusionSection.content : '',
